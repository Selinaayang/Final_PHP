...
<center><input type="button" value="檢視表單" onclick="location.href='formcheck.php'">&nbsp;<input type="button" value="回上一頁" onclick="location.href='schedule.php'"></center>